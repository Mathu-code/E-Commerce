...
//import { createReview } from "../../../../backend/controllers/productController";
...
export default function ProductDetail() {
    ...
    },[error,dispatch,id,isReviewSubmitted])
    return (
        <Fragment>
            {loading? <Loader/>:
            <Fragment>
            ...
            <div className="row f-flex justify-content-around">
                <div className="col-12 col-lg-5 img-fluid" id="product_image">
                     <Carousel pause="hover"> 
                       ...
                       <img
                           ...
                           src={image.image} // Make sure this is the correct property
                           alt={product.name}
                           height="500"
                           width="500"
                      />
                ...
                <div className="col-12 col-lg-5 mt-5">
                    ...
                    {user ?
                    <button  onClick={handleShow} id="review_btn" type="button" className="btn btn-primary mt-4" data-toggle="modal"
