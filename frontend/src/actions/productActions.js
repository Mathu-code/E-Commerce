...
//import { deleteOrderSuccess } from '../slices/orderSlice';
...
export const getAdminProducts = async (dispatch) => {
  ...
  error.response?.data?.message || error.message || " Product Update Failed"
    ))
...
export const createNewProduct = productData => async (dispatch) => {
  ...
  error.response?.data?.message || error.message || "Create New Product Failed"
    ))
